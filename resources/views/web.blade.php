...
<section id='works' class="s-works">
    ...
    <div class="intro-wrap">
        ...
        <div class="row section-header has-bottom-sep light-sep" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead">Welcome to our web Design & Development portfolio</h3>
                <h1 class="display-2 display-2--light">We love what we do, check out some of our latest Designs</h1>
            </div>
