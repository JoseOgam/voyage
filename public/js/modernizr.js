...
!function (e, n, t) {
    ...
    function o() {
        var e, n, t, o, a, s, i;
        for (var c in x) if (x.hasOwnProperty(c)) {
    ...
    function v(e, n, o, a) {
        ...
        for (p = e.length, u = 0; p > u; u++) if (v = e[u], g = j.style[v], d(v, "-") && (v = i(v)), j.style[v] !== t) {
    ...
    var w = n.documentElement, b = "svg" === w.nodeName.toLowerCase();
    ...
    var S = "CSS" in e && "supports" in e.CSS, P = "supportsCSS" in e;
    ...
    var E = "Moz O ms Webkit", z = T._config.usePrefixes ? E.split(" ") : [];
    T._cssomPrefixes = z;
    var k = function (n) {
